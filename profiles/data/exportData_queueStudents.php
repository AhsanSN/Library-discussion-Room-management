...
$productResult = $db_handle->runQuery("select * from lib_bookingQueue order by id desc");
...
<h2 style="text-align:center;">Queued Students Data</h2>

<div id="table-container">
    <div class="btn">
        <button onclick="exportTableToExcel('tab', 'HULib-queuedStudents')" id="btnExport" name='export'
    ...
    <table id="tab">
        ...
        <tbody>
            ...
            <?php
            $query = $db_handle->runQuery("select * from lib_bookingQueue order by id desc");
            if (! empty($productResult)) {
                ...
                <td><?php echo $productResult[$key]["occupants"]; ?></td>
